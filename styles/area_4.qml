...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" readOnly="0" minScale="100000000" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" version="3.18.3-Zürich" maxScale="0" simplifyDrawingHints="1" simplifyAlgorithm="0" labelsEnabled="0" simplifyMaxScale="1">
  <flags>
  ...
  <temporal durationField="" startExpression="" durationUnit="min" mode="0" startField="" enabled="0" accumulate="0" fixedDuration="0" endField="" endExpression="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
      ...
      <symbol name="0" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer class="PointPatternFill" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option value="14" name="distance_y" type="QString"/>
          ...
          <symbol name="@0@0" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
            ...
            <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
              <Option type="Map">
                ...
                <Option value="bevel" name="joinstyle" type="QString"/>
                <Option value="cross_fill" name="name" type="QString"/>
                <Option value="4,7" name="offset" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MM" name="offset_unit" type="QString"/>
                <Option value="0,0,0,255" name="outline_color" type="QString"/>
                <Option value="solid" name="outline_style" type="QString"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory width="15" backgroundAlpha="255" scaleBasedVisibility="0" barWidth="5" opacity="1" lineSizeScale="3x:0,0,0,0,0,0" direction="0" penWidth="0" enabled="0" rotationOffset="270" showAxis="1" sizeType="MM" spacingUnit="MM" maxScaleDenominator="1e+08" height="15" minScaleDenominator="0" scaleDependency="Area" minimumSize="0" backgroundColor="#ffffff" sizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" diagramOrientation="Up" penColor="#000000" penAlpha="255" spacing="5" spacingUnitScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight">
  ...
  <DiagramLayerSettings placement="1" dist="0" priority="0" zIndex="0" linePlacementFlags="18" obstacle="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
