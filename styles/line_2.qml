...
<qgis maxScale="0" simplifyDrawingTol="1" version="3.18.3-Zürich" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingHints="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyLocal="1">
  ...
  <DiagramLayerSettings placement="2" linePlacementFlags="18" zIndex="0" obstacle="0" showAll="1" dist="0" priority="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="7" name="" field="z_order"/>
    <alias index="8" name="" field="other_tags"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="highway" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="waterway" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="aerialway" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="z_order" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" name="waterway" type="field" hidden="0"/>
      <column width="-1" name="aerialway" type="field" hidden="0"/>
      <column width="-1" name="barrier" type="field" hidden="0"/>
      <column width="-1" name="man_made" type="field" hidden="0"/>
      <column width="-1" name="z_order" type="field" hidden="0"/>
