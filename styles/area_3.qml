...
<qgis maxScale="0" simplifyDrawingTol="1" version="3.18.3-Zürich" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingHints="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyLocal="1">
  <flags>
  ...
  <temporal accumulate="0" endField="" fixedDuration="0" mode="0" endExpression="" durationField="" durationUnit="min" startField="" startExpression="" enabled="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory backgroundColor="#ffffff" width="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270" minimumSize="0" penAlpha="255" showAxis="1" sizeType="MM" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" enabled="0" diagramOrientation="Up" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" spacing="5" penWidth="0" scaleBasedVisibility="0" backgroundAlpha="255" direction="0" lineSizeType="MM" penColor="#000000" spacingUnit="MM" maxScaleDenominator="1e+08" barWidth="5" height="15" opacity="1" minScaleDenominator="0">
  ...
  <DiagramLayerSettings placement="1" linePlacementFlags="18" zIndex="0" obstacle="0" showAll="1" dist="0" priority="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="1" name="" field="osm_way_id"/>
    <alias index="2" name="" field="name"/>
    <alias index="3" name="" field="type"/>
    <alias index="4" name="" field="aeroway"/>
    <alias index="5" name="" field="amenity"/>
    <alias index="6" name="" field="admin_level"/>
    <alias index="7" name="" field="barrier"/>
    <alias index="8" name="" field="boundary"/>
    <alias index="9" name="" field="building"/>
    <alias index="10" name="" field="craft"/>
    <alias index="11" name="" field="geological"/>
    <alias index="12" name="" field="historic"/>
    <alias index="13" name="" field="land_area"/>
    <alias index="14" name="" field="landuse"/>
    <alias index="15" name="" field="leisure"/>
    <alias index="16" name="" field="man_made"/>
    <alias index="17" name="" field="military"/>
    <alias index="18" name="" field="natural"/>
    <alias index="19" name="" field="office"/>
    <alias index="20" name="" field="place"/>
    <alias index="21" name="" field="shop"/>
    <alias index="22" name="" field="sport"/>
    <alias index="23" name="" field="tourism"/>
    <alias index="24" name="" field="other_tags"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="craft"/>
    <default applyOnUpdate="0" expression="" field="geological"/>
    <default applyOnUpdate="0" expression="" field="historic"/>
    <default applyOnUpdate="0" expression="" field="land_area"/>
  ...
  <constraints>
    ...
    <constraint field="osm_way_id" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="aeroway" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="amenity" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="admin_level" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="barrier" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="boundary" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="building" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="craft" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="geological" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="historic" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="land_area" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="landuse" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="leisure" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="man_made" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="military" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="natural" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="office" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="place" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="shop" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="sport" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="tourism" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="other_tags" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" name="osm_way_id" type="field" hidden="0"/>
      <column width="-1" name="name" type="field" hidden="0"/>
      <column width="-1" name="type" type="field" hidden="0"/>
      <column width="-1" name="aeroway" type="field" hidden="0"/>
      <column width="-1" name="amenity" type="field" hidden="0"/>
      <column width="-1" name="admin_level" type="field" hidden="0"/>
      <column width="-1" name="barrier" type="field" hidden="0"/>
      <column width="-1" name="boundary" type="field" hidden="0"/>
      <column width="-1" name="building" type="field" hidden="0"/>
      <column width="-1" name="craft" type="field" hidden="0"/>
      <column width="-1" name="geological" type="field" hidden="0"/>
      <column width="-1" name="historic" type="field" hidden="0"/>
      <column width="-1" name="land_area" type="field" hidden="0"/>
      <column width="-1" name="landuse" type="field" hidden="0"/>
      <column width="-1" name="leisure" type="field" hidden="0"/>
      <column width="-1" name="man_made" type="field" hidden="0"/>
      <column width="-1" name="military" type="field" hidden="0"/>
      <column width="-1" name="natural" type="field" hidden="0"/>
      <column width="-1" name="office" type="field" hidden="0"/>
      <column width="-1" name="place" type="field" hidden="0"/>
      <column width="-1" name="shop" type="field" hidden="0"/>
      <column width="-1" name="sport" type="field" hidden="0"/>
      <column width="-1" name="tourism" type="field" hidden="0"/>
      <column width="-1" name="other_tags" type="field" hidden="0"/>
